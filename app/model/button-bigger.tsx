...
export default function ButtonBigger() {
  ...
  const yesButtonSize = Math.min(noCount * 10 + 16, 60); // Pertumbuhan lebih lambat dan batas lebih kecil
  ...
  const isFullPageYes = noCount >= 10; // Aktifkan mode layar penuh setelah 10 kali klik "No"
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-linear-to-br from-pink-100 to-rose-200 selection:bg-rose-600 selection:text-white">
      ...
      <div
        className={`z-10 w-full max-w-md p-8 mx-4 transition-all duration-500 ${isFullPageYes ? "opacity-0 scale-90" : "bg-white/40 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50"} text-center`}
      >
        {yesPressed ? (
          ...
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="flex flex-col items-center gap-4">
              <button
                className="bg-rose-500 hover:bg-rose-600 text-white font-bold py-4 px-8 rounded-full shadow-lg shadow-rose-300/50 transition-all duration-300 hover:scale-110 active:scale-95 z-20 w-full"
